...
<div class="container" id="login-section">
  ...
  <div class="row">
    ...
    <div class="col-sm-4 col-sm-offset-4 form-section">
      <h1 class="text-center" style="font-family: 'Oswald', sans-serif;">Add Bank Teller</h1>

      <div class="tab-content form-content">
        <div id="jobSeeker" class="tab-pane fade in active">
          <form data-toggle="validator" class="form-horizontal" id="jobSeeker-form" action="addStaff.php" method="POST">
            <fieldset>
